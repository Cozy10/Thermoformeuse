...
echo
curl -d '["auth", "julien"]' -H "Content-Type: application/json" -X POST http://localhost:3000
echo
curl -d '["set_password", "jude"]' -H "Content-Type: application/json" -X POST http://localhost:3000
